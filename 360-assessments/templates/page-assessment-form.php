            ...
            <div class="assessment-container">
                ...
                <?php if (isset($_GET['message'])): ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo esc_html((string)$_GET['message']); ?>
                ...
                <div class="assessment-header">
                    ...
                    <div class="assessment-info">
                        <p><strong>Assessing:</strong> <?php echo esc_html((string)$assessee->first_name . ' ' . $assessee->last_name); ?></p>
                        <p><strong>Position:</strong> <?php echo esc_html((string)$assessee->position_name); ?></p>
                    </div>
                </div>
                ...
                <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" id="assessment-form">
                    ...
                    <?php foreach ($sections as $section_id => $section): ?>
                        <div class="assessment-section">
                            <h2><?php echo esc_html((string)$section['name']); ?></h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="question-text">
                                                <?php echo esc_html((string)$question->question_text); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
