...
add_action('admin_enqueue_scripts', function($hook) {
    if (strpos($hook, 'assessment-360') !== false) {
        ...
        // NEW: Chart.js library (always enqueued with charts)
        wp_enqueue_script('chartjs', 'https://cdn.jsdelivr.net/npm/chart.js', [], null, true);

        // NEW: Assessment 360 custom chart functions (depends on Chart.js)
        wp_enqueue_script(
            'assessment-360-charts',
            ASSESSMENT_360_PLUGIN_URL . 'assets/js/assessment-360-charts.js',
            ['chartjs'],
