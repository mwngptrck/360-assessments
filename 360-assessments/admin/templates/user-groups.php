...
if ($action === 'edit' && $group_id > 0) {
    ...
    if ($group) {
        ...
        // Prevent editing system groups ONLY if we are truly on the groups tab
        if (
            // Only do this redirect if tab=groups or if tab is not set (default view is groups)
            (!isset($_GET['tab']) || $_GET['tab'] === 'groups') &&
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" id="group-form">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i> <?php echo $group ? 'Update Group' : 'Add Group'; ?>
                            </button>
