...
<div class="wrap">
    <div class="mb-4 d-sm-flex align-items-center">
        ...
        <a href="<?php echo esc_url(add_query_arg(['page' => 'assessment-360-users'], admin_url('admin.php'))); ?>" 
                                            ...
                                            <tbody>
                                                <?php foreach ($assessments as $assessment): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="badge bg-<?php echo $assessment->status === 'completed' ? 'success' : 'warning'; ?>">
                    ...
                    <?php else: ?>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <?php 
                                if (WP_DEBUG) {
                                    error_log('Before displaying assessees list');
                                    error_log('Empty check result: ' . (empty($assessees) ? 'true' : 'false'));
                                }
...
<style>
.wp-heading-inline {display: block}
.avatar-circle {
    width: 80px;
    height: 80px;
