...
function assessment_360_import_dummy_data_handler() {
    ...
    $wpdb->query("INSERT INTO {$prefix}360_users (id, first_name, last_name, email, phone, password, position_id, group_id, department_id, status, created_at) VALUES
        (1, 'Alice', 'Peer', 'alice.peer@example.com', '0712345678', MD5('qwe123'), 1, 1, 1, 'active', NOW()),
        (2, 'Bob', 'Peer', 'bob.peer@example.com', '0722345678', MD5('qwe123'), 2, 1, 1, 'active', NOW()),
        (3, 'Charlie', 'Peer', 'charlie.peer@example.com', '0732345678', MD5('qwe123'), 2, 1, 2, 'active', NOW()),
        (4, 'Diana', 'Peer', 'diana.peer@example.com', '0742345678', MD5('qwe123'), 3, 1, 2, 'active', NOW()),
        (5, 'Ethan', 'Peer', 'ethan.peer@example.com', '0752345678', MD5('qwe123'), 1, 1, 1, 'active', NOW()),
