...
class Assessment_360_Auth_Handler {
    ...
    public function init() {
        // Plugin user login/logout - BOTH for logged in and not logged in users!
        add_action('admin_post_nopriv_assessment_360_login', array($this, 'handle_plugin_login'));
        add_action('admin_post_assessment_360_login', array($this, 'handle_plugin_login'));
        add_action('admin_post_nopriv_assessment_360_logout', array($this, 'handle_plugin_logout'));
