...
class Assessment_360_Question {
    ...
    public function create_question($data) {
        ...
        $result = $wpdb->insert(
            ...
            array(
                ...
                'has_comment_box'  => !empty($data['has_comment_box']) ? 1 : 0,
                'status'           => 'active'
            ),
            array('%s', '%d', '%d', '%d', '%d', '%s')
        );
    ...
    public function delete_question($question_id) {
        global $wpdb;
        $tab = isset($_POST['tab']) ? sanitize_text_field($_POST['tab']) : 'questions';
    ...
    public function handle_form_submission() {
        ...
        $data = array(
            ...
            'has_comment_box'  => !empty($_POST['has_comment_box']) ? 1 : 0
        );
