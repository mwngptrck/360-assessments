                                        ...
                                        <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                                            ...
                                            <div class="mb-3">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="bi bi-plus-lg me-1"></i><?php echo $edit_topic ? 'Update Topic' : 'Add Topic'; ?>
                                                </button>
                                                <?php if ($edit_topic): ?>
                                                    <a href="?page=assessment-360-forms#topics" class="btn btn-secondary"><i class="bi bi-x-circle me-1"></i>Cancel</a>
                                                <?php endif; ?>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="bi bi-trash"></i> Delete Topic</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="alert alert-warning">
                                            ...
                                            This action cannot be undone. All associated questions will also be deleted.
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                                            <?php wp_nonce_field('delete_topic', 'delete_topic_nonce'); ?>
                                            <input type="hidden" name="action" value="delete_topic">
                                            <input type="hidden" name="id" id="deleteTopicId">
                                            <input type="hidden" name="tab" value="<?php echo esc_attr(isset($_GET['tab']) ? $_GET['tab'] : 'topics'); ?>">
                    ...
                    <div class="tab-pane fade" id="sections" role="tabpanel">
                                ...
                                <div class="card w-100">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                                            ...
                                            <div class="mb-3">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="bi bi-plus-lg me-1"></i><?php echo $edit_section ? 'Update Section' : 'Add Section'; ?>
                                                </button>
                                                <?php if ($edit_section): ?>
                                                    <a href="?page=assessment-360-forms#sections" class="btn btn-secondary"><i class="bi bi-x-circle me-1"></i>Cancel</a>
                                                <?php endif; ?>
                                            </div>
                                        </form>
                                    </div>
                                                                                ...
                                                                                <td class="text-end">
                                                                                    <div class="btn-group">
                                                                                        <a href="?page=assessment-360-forms&action=edit_section&id=<?php echo esc_attr($section->id); ?>#sections" 
                                                                                           class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil-square"></i> Edit</a>
                                                                                        <button type="button" 
                                                                                            class="btn btn-sm btn-outline-danger delete-section"
                                                                                            data-bs-toggle="modal" 
                                                                                            data-bs-target="#deleteSectionModal"
                                                                                            data-id="<?php echo esc_attr($section->id); ?>"
                                                                                            data-name="<?php echo esc_attr($section->name); ?>">
                                                                                        <i class="bi bi-trash"></i> Delete
                                                                                    </button>
                                                                                    </div>
                                                                                </td>
                        ...
                        <div class="modal fade" id="deleteSectionModal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="bi bi-trash"></i> Delete Section</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div class="alert alert-warning">
                                            <i class="bi bi-exclamation-triangle me-2"></i>
                                            This action cannot be undone. All associated questions will be moved to the general section.
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="bi bi-x-circle me-1"></i>Cancel</button>
                                        <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                                            <?php wp_nonce_field('delete_section', 'delete_section_nonce'); ?>
                                            <input type="hidden" name="action" value="delete_section">
                                            <input type="hidden" name="id" id="deleteSectionId">
                                            <input type="hidden" name="tab" value="<?php echo esc_attr(isset($_GET['tab']) ? $_GET['tab'] : 'sections'); ?>">
                                            <button type="submit" class="btn btn-danger">
                    ...
                    <div class="tab-pane fade" id="questions" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-check">
                                                            <input type="hidden" name="has_comment_box" value="0">
                                                            <input type="checkbox" 
                                                                class="form-check-input"
                                                                id="has_comment_box" 
                                                ...
                                                <div class="col-md-7">
                                                    <div class="mb-3">
                                                        <button type="submit" class="btn btn-primary">
                                                            <i class="bi bi-plus-lg me-1"></i><?php echo $edit_question ? 'Update Question' : 'Add Question'; ?>
                                                        </button>
                                                        <?php if ($edit_question): ?>
                                                            <a href="?page=assessment-360-forms#questions" class="btn btn-secondary"><i class="bi bi-x-circle me-1"></i>Cancel</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                                                            ...
                                                                            <?php foreach ($position_data['questions'] as $question): ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-end">
                                                                                        <div class="btn-group">
                                                                                            <a href="?page=assessment-360-forms&action=edit_question&id=<?php echo esc_attr($question->id); ?>#questions" 
                                                                                               class="btn btn-sm btn-outline-primary"> <i class="bi bi-pencil-square"></i> Edit <!--Edit--></a>
                                                                                            <button type="button" 
                                                                                                ...
                                                                                                <i class="bi bi-trash"></i> Delete <!--Delete-->
                                                                                            </button>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                        ...
                        <div class="modal fade" id="deleteQuestionModal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="bi bi-trash"></i> Delete Question</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Are you sure you want to delete this question? <br><b><i class="bi bi-exclamation-triangle me-2"></i>This action cannot be undone.</b> </p>
                                        
                                        <div class="alert alert-warning question-preview mb-3">
                                            <strong>Question:</strong>
                                            <p id="deleteQuestionText" class="mb-0 mt-2"></p>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="bi bi-x-circle me-1"></i>Cancel</button>
                                        <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                                            <?php wp_nonce_field('delete_question'); ?>
                                            <input type="hidden" name="action" value="delete_question">
                                            <input type="hidden" name="id" id="deleteQuestionId">
                                            <input type="hidden" name="tab" value="<?php echo esc_attr(isset($_GET['tab']) ? $_GET['tab'] : 'questions'); ?>">
                                            <button type="submit" class="btn btn-danger">
                                    ...
                                    if (isset($_GET['preview_position']) && !empty($_GET['preview_position'])):
                                        ...
                                        if ($position):
                                            ...
                                            if (empty($sections)):
                                                ...
                                                ?>
                                                <div class="col-sm-9">
                                                    <div class="form-preview-wrapper mt-0">
                                                    <!-- Form Header -->
                                                    <div class="card mt-0">
                                                        <div class="card-body">
                                                                                    ...
                                                                                    <div class="section-preview mb-4">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <?php foreach ($questions as $question): ?>
                                                                                                <div class="col question-preview mb-3">
                                                                                                    <div class="card-body">
...
jQuery(document).ready(function($) {
    ...
    // Delete topic modal handling
    $('.delete-topic').on('click', function() {
        const id = $(this).data('id');
        const name = $(this).data('name');
        
        $('#deleteTopicId').val(id);
        $('#deleteTopicName').text(name);
    });

    // Add loading state to delete form
    $('#deleteTopicModal form').on('submit', function() {
        $(this).find('button[type="submit"]')
            .prop('disabled', true)
            .html('<i class="bi bi-hourglass-split me-2"></i>Deleting...');
    });
        
    // Delete question modal handling
    $('.delete-question').on('click', function() {
        const id = $(this).data('id');
        const text = $(this).data('text');
        
        $('#deleteQuestionId').val(id);
        $('#deleteQuestionText').text(text);
    });

    // Add loading state to delete form
    $('#deleteQuestionModal form').on('submit', function() {
        $(this).find('button[type="submit"]')
            .prop('disabled', true)
            .html('<i class="bi bi-hourglass-split me-2"></i>Deleting...');
    });
    ...
    $('#deleteQuestionModal form').on('submit', function() {
        if ($('#deleteQuestionId').val()) {
            return true;
        }
        return false;
    });
        
    // Delete section modal handling
    ...
    // Add loading state to delete form
    $('#deleteSectionModal form').on('submit', function() {
        $(this).find('button[type="submit"]')
            .prop('disabled', true)
            .html('<i class="bi bi-hourglass-split me-2"></i>Deleting...');
    });
