                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 stats fs-4"><?php echo $stats->completion_rate; ?>%</p>
                                <p class="mb-0">Completed: <?php echo $stats->completed_assessments; ?> / <?php echo esc_html($stats->total_assessments); ?></p>
                                <small>Pending: <?php echo max(0, $stats->total_assessments - $stats->completed_assessments); ?></small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h6 class="mb-1"><?php echo esc_html($group['group_name']); ?></h6>
                                <p class="mb-0">
                                    Users: <strong><?php echo esc_html($group['user_count']); ?></strong><br>
                                    Completion: <strong><?php echo esc_html($group['completion_rate']); ?>%</strong>
                                </p>
                                <div class="progress" style="height:6px;">
                                    <div class="progress-bar" role="progressbar" style="width: <?php echo esc_attr($group['completion_rate']); ?>%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
