...
// Instantiate the assessment manager
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="text-muted me-3">
                            <i class="bi bi-calendar3"></i> Today is
                            <?php echo date('F j, Y'); ?>
                        </span>
                    </div>
                </div>
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 text-white">
                                    <?php echo $current_assessment ? 
                                        ...
                                        '<span class="text-white">There is NO active assessment. <br> <a class="text-white" href="admin.php?page=assessment-360-assessments&action=new">Create an assessment</a> </span>'; ?>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 text-white">
                                    ...
                                    <?php echo isset($stats->total_assessors) ? esc_html($stats->total_assessors) : '0'; ?> completed
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 text-white"><?php echo $stats->active_users; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
